...
(function () {
  ...
  const T = {
    en: {
      ...
      rated: "already rated", ratedToast: "Already rated on the profiler page.",
      lookingUp: "Looking it up…", notFound: "Not found. You can add it by name on the profiler page.",
      ...
      noFamilies: "No family stands out yet. More bottles on the profiler page will show one.",
      ...
      oneMore: "One more bottle gives you three recommendations. Add it on the profiler page.",
    ...
    ar: {
      ...
      rated: "قيّمته من قبل", ratedToast: "قيّمته من قبل في صفحة المحلل.",
      lookingUp: "جارٍ البحث عنه…", notFound: "لم نجده. يمكنك إضافته باسمه في صفحة المحلل.",
      ...
      oneMore: "عطر واحد آخر يعطيك ثلاثة ترشيحات. أضفه في صفحة المحلل.",
